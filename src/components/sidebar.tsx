  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'relative bg-transparent w-[--sidebar-width] h-svh transition-[width] duration-200 ease-linear',
        ...
        <div
          className={cn(
            'hidden z-10 fixed inset-y-0 md:flex w-[--sidebar-width] h-svh transition-[left,right,width] duration-200 ease-linear',
            side === 'left'
