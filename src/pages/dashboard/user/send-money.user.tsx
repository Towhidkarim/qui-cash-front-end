...
export default function SendMoneyPage() {
  ...
  const [sendMoney, { isLoading: transactionIsLoading }] =
  ...
  const handleSendMoney = async () => {
    ...
    if (!res.data?.data) {
      toast.error('Send Money failed, error occured');
      ...
      <div className='mx-auto max-w-2xl'>
        ...
        <div className='mb-8'>
          <div className='flex justify-between items-center mb-4'>
            <h1 className='font-bold text-foreground text-3xl'>Send Money</h1>
        ...
        {currentStep === 'search' && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Choose the recipient from the search results for {phoneNumber}
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className='flex justify-between'>
                      <span className='text-muted-foreground'>
                        Transaction Fee {`(${COMISSIONS.sendMoney * 100}%)`} :
                      </span>
                      <span>
                        TK {(amount * COMISSIONS.sendMoney).toFixed(2)}
                      </span>
                    </div>
                    <div className='mt-2 pt-2 border-t'>
                      <div className='flex justify-between font-medium'>
                        ...
                        <span className='text-lg'>
                          TK{' '}
                          {(amount + amount * COMISSIONS.sendMoney).toFixed(2)}
                        </span>
                      </div>
                    </div>
                  </div>
